...
describe("ForgeInstaller", () => {
    ...
    test("should install forge on 1.7.10", async () => {
        ...
        await expect(exists(join(gameDirectory, "versions", "1.7.10-Forge10.13.3.1400-1.7.10", "1.7.10-Forge10.13.3.1400-1.7.10.json")))
            .resolves
            .toBeTruthy();
    });
    test("should install forge on 1.12.2", async () => {
        ...
        await expect(exists(join(gameDirectory, "versions", "1.12.2-forge1.12.2-14.23.5.2823", "1.12.2-forge1.12.2-14.23.5.2823.json")))
            .resolves
            .toBeTruthy();
    ...
    test("should install forge 1.13.2-25.0.209", async () => {
        ...
        await expect(exists(join(gameDirectory, "versions", "1.13.2-forge-25.0.209", "1.13.2-forge-25.0.209.json")))
            .resolves
            .toBeTruthy();
        // await Installer.installDependencies(await Version.parse(gameDirectory, result));
        // await assertNoError(result, gameDirectory);
    ...
    test("should install forge 1.14.4-forge-28.0.45", async () => {
        ...
        await expect(exists(join(gameDirectory, "versions", "1.14.4-forge-28.0.45", "1.14.4-forge-28.0.45.json")))
            .resolves
            .toBeTruthy();
        // await Installer.installDependencies(await Version.parse(gameDirectory, result));
        // await assertNoError(result, gameDirectory);
