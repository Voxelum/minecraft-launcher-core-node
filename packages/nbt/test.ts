...
describe("NBT", () => {
    ...
    it("should ignore the additional field in serialization", () => {
        ...
        const testSerialized = serializer.serialize(input, "test", false);
        ...
        const reversed = serializer.deserialize(testSerialized);
        const reversedDirect = NBT.Serializer.deserialize(testSerialized);
