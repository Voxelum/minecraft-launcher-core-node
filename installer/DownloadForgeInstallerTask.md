...
```ts
new DownloadForgeInstallerTask(forgeVersion: string, installer: undefined | Object, minecraft: MinecraftFolder, options: InstallForgeOptions, legacy: boolean): DownloadForgeInstallerTask
```
#### Parameters
...
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/forge.ts#L149" target="_blank" rel="noreferrer">packages/installer/forge.ts:149</a>
</p>
