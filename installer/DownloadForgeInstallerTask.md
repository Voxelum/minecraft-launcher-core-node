...
```ts
DownloadForgeInstallerTask(forgeVersion: string, installer: undefined | { path: string; sha1?: string }, minecraft: MinecraftFolder, options: InstallForgeOptions, legacy: boolean): DownloadForgeInstallerTask
```
#### Parameters

- **forgeVersion**: `string`
- **installer**: `undefined | { path: string; sha1?: string }`
...
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/forge.ts#L150" target="_blank" rel="noreferrer">packages/installer/forge.ts:150</a>
</p>
...
```
<p style="font-size: 14px; color: var(--vp-c-text-2)">
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/forge.ts#L148" target="_blank" rel="noreferrer">packages/installer/forge.ts:148</a>
</p>
