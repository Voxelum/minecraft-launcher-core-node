...
```ts
InstallLibraryTask(libs: ResolvedLibrary[], folder: MinecraftFolder, options: LibraryOptions): InstallLibraryTask
```
#### Parameters
...
<strong>Defined in:</strong> <a href="https://github.com/voxelum/minecraft-launcher-core-node/blob/master/packages/installer/minecraft.ts#L499" target="_blank" rel="noreferrer">packages/installer/minecraft.ts:499</a>
</p>
...
```ts
map(transform: Transform<InstallLibraryTask, N>): Task<N extends Promise<R> ? R : N>
```
#### Parameters
