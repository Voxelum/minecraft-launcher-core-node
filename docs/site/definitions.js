module.exports['@xmcl/client/client.d.ts'] = `/// <reference types="node" />
...
`;
module.exports['@xmcl/client/default-protocol.d.ts'] = `import Long from "long";
...
`;
module.exports['@xmcl/client/index.d.ts'] = `import { TextComponent, TextComponentFrame } from "@xmcl/text-component";
...
export declare namespace Server {
    class Status {
        ...
        readonly playerList?: GameProfile[] | undefined;
        readonly modInfos?: {
            type: string;
            modList: ForgeModIdentity[];
        } | undefined;
        static pinging(): Status;
        static error(): Status;
        static from(obj: ServerStatusFrame | Status): Status;
        pingToServer?: number;
        constructor(gameVersion: TextComponent, serverMOTD: TextComponent, protocolVersion: number, onlinePlayers: number, capacity: number, icon?: string | undefined, playerList?: GameProfile[] | undefined, modInfos?: {
            type: string;
            modList: ForgeModIdentity[];
        } | undefined);
        toString(): string;
     ...
     */
    function fetchStatusFrame(server: {
        host: string;
        port?: number;
     ...
     * @param options The fetch options
     */
    function fetchStatus(server: {
        host: string;
        port?: number;
    }, options?: FetchOptions): Promise<Status>;
    type StatusFrame = ServerStatusFrame;
    type Info = ServerInfoFrame;
}
export * from "./coders";
export * from "./packet";
...
export * from "./client";
`;
module.exports['@xmcl/client/packet.d.ts'] = `import { State } from "./client";
import { Coder } from "./coders";
...
export declare function Packet(side: Side, id: number, state: State): (constructor: Function) => void;
export declare namespace Packet {
    function clear(): void;
    function flush(): PacketRegistryEntry[];
}
export declare type Protocol = () => PacketRegistryEntry[];
export declare class ProtocolManager {
    private mapping;
    register(protocolId: number, protocol: Protocol): void;
}
`;
module.exports['@xmcl/client/status-client.d.ts'] = `import { Channel } from "./client";
export declare class StatusClient {
    readonly protocol: number;
    readonly timeout?: number | undefined;
    static create(protocol: number, timeout?: number): StatusClient;
...
`;
module.exports['@xmcl/nbt/index.module.d.ts'] = `export * from "./nbt";
`;
module.exports['@xmcl/nbt/nbt.d.ts'] = `import ByteBuffer from "bytebuffer";
declare type Constructor<T> = new (...args: any) => T;
export declare const NBTAlias: unique symbol;
...
export declare function TagType<T>(type: TagType | string | Constructor<T>): (target: any, key: string) => void;
export declare function TagTypeAlias(alias: string): (constructor: Function) => void;
...
export declare type Schema = ListSchema | CompoundSchema;
...
export declare type TypeIdentity = Schema | string | TagType;
export interface IO {
 ...
 */
export declare function serialize(object: TypedObject, option?: SerializationOption): Promise<Uint8Array>;
/**
 * Deserialize the nbt binary into json
 * @param fileData The nbt binary
 */
export declare function deserialize<T>(fileData: Uint8Array, option?: SerializationOption): Promise<T>;
/**
 * Serialzie an nbt typed json object into NBT binary
 * @param object The json
 */
export declare function serializeSync(object: TypedObject, option?: SerializationOption): Uint8Array;
/**
 * Deserialize the nbt binary into json
 * @param fileData The nbt binary
 * @param compressed Should we compress it
 */
export declare function deserializeSync<T>(fileData: Uint8Array, option?: SerializationOption): T;
export declare function getPrototypeOf(object: object): CompoundSchema | undefined;
interface Registry {
    schema: CompoundSchema;
    construct: Constructor<any>;
}
export declare class InspectContext {
    type: TypeIdentity;
    constructor(type: TypeIdentity);
    fork(tagType: number): InspectContext;
}
export declare class KnownReadContext {
    readonly reg: Registry;
    private properties;
    private conToReg;
    constructor(reg: Registry, properties: Record<string, Registry>, conToReg: Map<Function, Registry>);
    getRegistry(type: TypeIdentity): Registry | undefined;
    fork(reg: Registry): KnownReadContext;
}
...
export declare class Serializer {
    private idToReg;
    private typeToReg;
    getSchema(type: string): Registry;
     ...
     */
    serialize<T>(object: T, option?: SerializationOption & {
     ...
     */
    serializeSync<T>(object: T, option?: SerializationOption & {
        type?: string | Constructor<T>;
    }): Uint8Array;
    /**
     ...
     */
    deserialize<T>(fileData: Uint8Array, type: Constructor<T> | string, option?: SerializationOption): Promise<T>;
    /**
     * Deserialize the nbt to json object directly
     * @param fileData The nbt data
     * @param compressed Does the data compressed
     */
    deserializeSync(fileData: Uint8Array, option?: SerializationOption): {
        value: any;
        type: any | string;
    };
}
...
export declare namespace BlockModel {
    ...
    type Resolved = Omit<Required<BlockModel>, "parent" | "override"> & {
...
`;
module.exports['@xmcl/system/index.module.d.ts'] = `export * from "./system";
`;
...
export * from "./service";
`;
module.exports['@xmcl/user/index.module.d.ts'] = `import "./setup.module";
export * from "./auth";
export { GameProfile, GameProfileWithProperties } from "./base";
export * from "./mojang";
export * from "./service";
...
`;
module.exports['@xmcl/user/setup.module.d.ts'] = `export {};
`;
