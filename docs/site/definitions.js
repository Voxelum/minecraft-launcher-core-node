...
`;
module.exports['@xmcl/client/esm/channel.d.ts'] = `/// <reference types="node" />
import { EventEmitter } from "events";
import { NetConnectOpts } from "net";
import { Coder } from "./coders";
import { PacketRegistryEntry, Side } from "./packet";
...
export {};
`;
module.exports['@xmcl/client/esm/coders.d.ts'] = `import ByteBuffer from "bytebuffer";
import Long from "long";
import "uuid";
export interface SlotData {
    blockId: number;
...
export default Coders;
`;
module.exports['@xmcl/client/esm/index.d.ts'] = `export * from "./coders";
export * from "./packet";
export * from "./channel";
export * from "./status";
`;
module.exports['@xmcl/client/esm/packet.d.ts'] = `import { State } from "./channel";
import { Coder } from "./coders";
...
`;
module.exports['@xmcl/client/esm/status.d.ts'] = `import { TextComponentFrame } from "@xmcl/text-component";
import Long from "long";
 ...
 */
export declare function fetchStatus(server: {
    host: string;
    port?: number;
}, options?: FetchOptions): Promise<ServerStatusFrame>;
/**
...
export declare function createClient(protocol: number, timeout?: number): {
    ...
    protocol: number;
    query(host: string, port?: number): Promise<ServerStatusFrame>;
};
export {};
`;
...
export declare function Packet(side: Side, id: number, state: State, name?: string): (constructor: Function) => void;
`;
module.exports['@xmcl/client/status.d.ts'] = `import { TextComponentFrame } from "@xmcl/text-component";
import Long from "long";
import { Channel } from "./channel";
export declare class Handshake {
    protocolVersion: number;
...
`;
module.exports['@xmcl/core/esm/folder.d.ts'] = `export interface MinecraftFolder {
...
`;
module.exports['@xmcl/core/esm/fs.d.ts'] = `/// <reference types="node" />
...
`;
module.exports['@xmcl/core/esm/index.d.ts'] = `export * from "./launch";
export * from "./version";
export * from "./platform";
export * from "./folder";
`;
module.exports['@xmcl/core/esm/launch.d.ts'] = `/// <reference types="node" />
...
`;
module.exports['@xmcl/core/esm/platform.d.ts'] = `export interface Platform {
...
`;
module.exports['@xmcl/core/esm/version.d.ts'] = `import { MinecraftLocation } from "./folder";
...
`;
module.exports['@xmcl/forge-site-parser/esm/index.d.ts'] = `interface Download {
    md5: string;
    sha1: string;
    path: string;
}
...
`;
module.exports['@xmcl/gamesetting/esm/index.d.ts'] = `export declare enum AmbientOcclusion {
    Off = 0,
    Minimum = 1,
    Maximum = 2
}
...
export declare function installByInstallerPartialTask(version: string | InstallProfile, minecraft: MinecraftLocation, option?: {
    java?: JavaExecutor;
} & LibraryOption): (context: Task.Context) => Promise<void>;
/**
 * Install for forge installer step 2 and 3.
 * @param version The version string or installer profile
 * @param minecraft The minecraft location
...
`;
module.exports['@xmcl/installer/esm/index.d.ts'] = `import * as FabricInstaller from "./fabric";
 ...
 */
export declare function installJreFromMojangTask(options: InstallOption): (context: Task.Context) => Promise<void>;
/**
 * Install JRE from Mojang offical resource. It should install jdk 8.
 * @param options The install options
 */
...
`;
module.exports['@xmcl/mod-parser/esm/fabric.d.ts'] = `import { FileSystem } from "@xmcl/system";
declare type Person = {
    /**
...
export {};
`;
module.exports['@xmcl/mod-parser/esm/forge.d.ts'] = `import { FileSystem } from "@xmcl/system";
/**
...
`;
module.exports['@xmcl/mod-parser/esm/index.d.ts'] = `import * as Forge from "./forge";
import * as LiteLoader from "./liteloader";
import * as Fabric from "./fabric";
export { Forge, LiteLoader, Fabric };
`;
module.exports['@xmcl/mod-parser/esm/liteloader.d.ts'] = `import { FileSystem } from "@xmcl/system";
export declare const DEFAULT_VERSION_MANIFEST = "http://dl.liteloader.com/versions/versions.json";
...
export {};
`;
module.exports['@xmcl/model/esm/block.d.ts'] = `import { BlockModel, PackMeta } from "@xmcl/resourcepack";
import { Object3D } from "three/src/core/Object3D";
import { Vector3 } from "three/src/math/Vector3";
interface Texture {
    url: string;
...
export {};
`;
module.exports['@xmcl/model/esm/index.d.ts'] = `export * from "./block";
export * from "./player";
`;
module.exports['@xmcl/model/esm/player-model.d.ts'] = `export interface ModelTemplate {
    head: Part;
    rightLeg: Part;
    leftLeg: Part;
    torso: Part;
...
`;
module.exports['@xmcl/model/esm/player.d.ts'] = `import { Object3D } from "three/src/core/Object3D";
...
export default PlayerModel;
`;
module.exports['@xmcl/nbt/esm/index.browser.d.ts'] = `export * from "./nbt";
`;
module.exports['@xmcl/nbt/esm/index.d.ts'] = `export * from "./nbt";
`;
module.exports['@xmcl/nbt/esm/nbt.d.ts'] = `import ByteBuffer from "bytebuffer";
...
export {};
`;
module.exports['@xmcl/nbt/esm/test.d.ts'] = `export {};
`;
module.exports['@xmcl/nbt/esm/utils.d.ts'] = `/// <reference types="bytebuffer" />
...
export declare function setZlib(lib: Zlib): void;
`;
module.exports['@xmcl/resource-manager/esm/index.d.ts'] = `import { PackMeta, ResourcePack, Resource, ResourceLocation } from "@xmcl/resourcepack";
...
`;
module.exports['@xmcl/resource-manager/esm/model-loader.d.ts'] = `import { BlockModel, Resource } from "@xmcl/resourcepack";
...
`;
module.exports['@xmcl/resourcepack/esm/format.d.ts'] = `/**
...
export {};
`;
module.exports['@xmcl/resourcepack/esm/index.d.ts'] = `import { FileSystem } from "@xmcl/system";
...
`;
module.exports['@xmcl/server-info/esm/index.d.ts'] = `export declare class ServerInfo {
    icon: string;
    ip: string;
    name: string;
...
`;
module.exports['@xmcl/system/esm/index.browser.d.ts'] = `export * from "./system";
`;
module.exports['@xmcl/system/esm/index.d.ts'] = `export * from "./system";
`;
module.exports['@xmcl/system/esm/system.d.ts'] = `export interface System {
    fs: FileSystem;
...
`;
module.exports['@xmcl/system/esm/test.d.ts'] = `export {};
`;
...
`;
module.exports['@xmcl/task/esm/index.d.ts'] = `/// <reference types="node" />
import { EventEmitter } from "events";
...
export declare class TaskBridge<X extends Task.State = Task.State> {
    ...
    protected enqueueTask<T>(signal: TaskSignal, task: TaskOrTaskObject<T>, parent?: X): {
        node: X;
        promise: Promise<T>;
    };
}
...
export declare namespace Task {
     ...
     */
    function execute<T>(task: TaskOrTaskObject<T>): TaskHandle<T, Task.State> & TaskListener;
    /**
    ...
    function create<T>(name: string, task: Task.Function<T>, parameters?: any): Task.Object<T>;
}
export default Task;
`;
...
`;
module.exports['@xmcl/text-component/esm/index.d.ts'] = `/**
...
export declare namespace Style {
     ...
     */
    function of(obj: Style | TextComponentFrame): Style;
    /**
     * Get Minecraft style code for the style
     */
    function getCode(style: Style): string;
}
...
export declare namespace TextComponent {
    type ClickEventAction = "open_file" | "open_url" | "run_command" | "suggest_command";
    type HoverEventAction = "show_text" | "show_item" | "show_entity";
    interface Event<T> {
     ...
     */
    function getSuggestedCss(style: Style): string;
    /**
     * Render a text component into html style object
     * @returns the render node hint for html/css info
     */
    function render(src: TextComponent): RenderNode;
    /**
     * Convert a text component to Minecraft specific formatted string like \`§1colored§r\`
     */
    function toFormattedString(comp: TextComponent): string;
    /**
     * Flat all components in this component by DFS into a list.
     * @param component The root component
     */
    function flat(component: TextComponent): TextComponent[];
    /**
     * Convert json format (server motd) or string to TextComponent Object
     */
    function from(obj: string | TextComponentFrame): TextComponent;
}
export declare class TextComponentString implements TextComponent {
    readonly text: string;
    protected _siblings: TextComponent[];
    private _style?;
    static of(text?: string, style?: Style, siblings?: TextComponent[]): TextComponentString;
    constructor(text?: string, style?: Style, siblings?: TextComponent[]);
    toString(): string;
    set style(style: Style);
    get style(): Style;
    get iterator(): TextComponent[];
    get formatted(): string;
    get siblings(): TextComponent[];
...
`;
module.exports['@xmcl/unzip/esm/index.d.ts'] = `/// <reference types="node" />
...
export {};
`;
module.exports['@xmcl/user/esm/auth.d.ts'] = `import { GameProfile } from "./base";
declare type LoginWithUser = {
    username: string;
    password: string;
    requestUser: true;
...
export {};
`;
module.exports['@xmcl/user/esm/base.d.ts'] = `/**
 * The game profile of the user.
 *
 * In auth response, it will usually carry the \`userId\`, \`createdAt\` properties.
 *
...
export {};
`;
module.exports['@xmcl/user/esm/index.browser.d.ts'] = `import "./setup.browser";
export * from "./auth";
export { GameProfile, GameProfileWithProperties } from "./base";
export * from "./mojang";
export * from "./service";
`;
module.exports['@xmcl/user/esm/index.d.ts'] = `import "./setup";
export * from "./auth";
export { GameProfile, GameProfileWithProperties } from "./base";
export * from "./mojang";
export * from "./service";
`;
module.exports['@xmcl/user/esm/mojang.d.ts'] = `/**
...
`;
module.exports['@xmcl/user/esm/service.d.ts'] = `import { GameProfile, GameProfileWithProperties } from "./base";
...
`;
module.exports['@xmcl/user/esm/setup.browser.d.ts'] = `export {};
`;
module.exports['@xmcl/user/esm/setup.d.ts'] = `export {};
`;
...
`;
module.exports['@xmcl/world/esm/index.d.ts'] = `import { FileSystem } from "@xmcl/system";
